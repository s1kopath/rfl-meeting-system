...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/bookings/{booking}', [BookingController::class, 'destroy'])->name('bookings.destroy');
    ...
    Route::middleware([RoleMiddleware::class . ':admin'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/rooms/{room}', [AdminRoomController::class, 'destroy'])->name('rooms.destroy');
